...
/**
 * Created by Deven Singh on 28-04-2016.
 */
public class IntroPageTransformer implements ViewPager.PageTransformer {
    ...
    public void transformPage(View page, float position) {
        ...
        View description = page.findViewById(R.id.tv_pager_texts);
        View computer = page.findViewById(R.id.iv_center);
        ...
        if (position <= -1.0f || position >= 1.0f) {
            computer.setScaleX(0.0f);
            computer.setScaleY(0.0f);
            // The page is not visible. This is a good place to stop
            // any potential work / animations you may have running.

        } else if (position == 0.0f) {
             computer.setScaleX(1.0f);
             computer.setScaleY(1.0f);
...
//            View title = page.findViewById(R.id.tv_pager_texts);
...
//            description.setTranslationX((float) (-(1 - position) * 0.5 * pageWidth/2));
//            computer.setTranslationX(-(1 - position) * 1.5f* pageWidth/2);
//            computer.setTranslationX((float) (-(1 - position) * pageWidth));
...
//            }
            ...
            if (position < 0) {
                ...
                description.setAlpha(1-2*absPosition);
                description.setScaleX(1-Math.abs(position));
//                description.setScaleY(1-Math.abs(position));
                computer.setScaleX(1-Math.abs(position));
                computer.setScaleY(1-Math.abs(position));
            } else {
                // Create your in animation here
                description.setAlpha(1-2*position);
                description.setScaleX(Math.abs(position-1));
//                description.setScaleY(Math.abs(position-1));
                computer.setScaleX(Math.abs(position-1));
                computer.setScaleY(Math.abs(position-1));
            }
        }
    }
